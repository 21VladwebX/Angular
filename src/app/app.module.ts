...
// import { InMemoryDataServices }  from './in-memory-data-anti-heroes.service';
...
@NgModule({
  ...
  imports: [
    ...
    //  HttpClientInMemoryWebApiModule.forRoot(
      //  InMemoryDataServices , { dataEncapsulation: false }
    //  ),

  ],
  providers: [ HeroService, MessageService, AntiHeroesService ],
